...
/// labels, with every component percent-encoded. The repo is nandish-jha/noop-app (bug_report.yml line 10).
final class TestReportLinkTests: XCTestCase {
    ...
    func testSleepProfileURLEncodesEveryFieldAndLabel() {
        ...
        XCTAssertTrue(s.hasPrefix("https://github.com/nandish-jha/noop-app/issues/new?"))
