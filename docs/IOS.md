...
> [Releases](https://github.com/nandish-jha/noop-app/releases) page and install it with **AltStore** or **SideStore** — see
...
2. **Download `NOOP-v<version>-ios.ipa`** from [Releases](https://github.com/nandish-jha/noop-app/releases) to your iPhone (or your
...
**Source URL:** `https://raw.githubusercontent.com/nandish-jha/noop-app/main/altstore-source.json`
