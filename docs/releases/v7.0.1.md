...
A fast follow-up to the [v7.0.0 "Everything" release](https://github.com/nandish-jha/noop-app/releases/tag/v7.0.0), fixing a batch of things you reported (and a few we caught ourselves while tightening our tests). Same app, just steadier.
