...
<p align="center"><sub><b>Personal fork</b> of <a href="https://github.com/nandish-jha/noop-app">NoopApp/noop</a> — maintained by <a href="https://github.com/nandish-jha">nandish-jha</a>. See <a href="UPSTREAM.md">UPSTREAM.md</a> to sync with upstream releases.</sub></p>
...
<p align="center">
  <a href="https://github.com/nandish-jha/noop-app/releases/latest"><img alt="Latest release" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Frelease.json&style=flat-square"></a>
  <a href="https://github.com/nandish-jha/noop-app/stargazers"><img alt="Stars" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Fstars.json&style=flat-square"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/nandish-jha/noop-app/wiki/FAQ">❓&nbsp;FAQ</a> ·
...
<p align="center">
  <a href="https://github.com/nandish-jha/noop-app/releases/latest"><img src="docs/assets/hero-v8.jpg" alt="NOOP in the new Liquid Metal design, on iPhone, Mac and Android" width="820"></a>
</p>
...
<p>
  <a href="https://github.com/nandish-jha/noop-app/releases/latest"><img alt="Version" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Frelease.json&style=flat-square"></a>
  <img alt="Released" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Freleased.json&style=flat-square">
</p>

| Platform | Build | Notes |
|---|---|---|
| **macOS** | `NOOP.app` (see [Releases](https://github.com/nandish-jha/noop-app/releases)) or Homebrew: `brew tap noopapp/noop && brew trust noopapp/noop && brew install --cask noop` | Apple Silicon + Intel. Drag to Applications. Not notarized — see **First launch on macOS** below. The one-time `brew trust noopapp/noop` is needed on Homebrew 6.0+ (harmless on older versions) — see [Homebrew docs](docs/HOMEBREW.md). |
| **Android** | `NOOP-full.apk` (see [Releases](https://github.com/nandish-jha/noop-app/releases)) | The full app. `minSdk 26` (Android 8+). Sideload — enable "install unknown apps". Blocked by Play Protect? See **Installing on Android** below. |
| **iOS** | `NOOP-vX-ios.ipa` (see [Releases](https://github.com/nandish-jha/noop-app/releases)) — sideload with AltStore/SideStore | Now a **direct download**. The `.ipa` is unsigned; **you** sign it on your iPhone with your own free Apple ID (no App Store, no developer account — NOOP stays anonymous). Re-signs every 7 days (AltStore automates it); Apple Health + Live Activity widgets may be limited under a free signing identity. See [docs/IOS.md](docs/IOS.md). Or build from source in Xcode. |
...
<p>
  <a href="https://github.com/nandish-jha/noop-app/releases/latest"><img alt="Latest across all platforms" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Frelease.json&style=flat-square"></a>
  <img alt="Commits per month" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Flastcommit.json&style=flat-square">
...
| **Android** | ✅ Full app (`android/`, Jetpack Compose, Android 8+). Pairs over BLE, persists and scores on-device, and imports WHOOP / Apple Health / Health Connect. Grab the APK from [Releases](https://github.com/nandish-jha/noop-app/releases). |
...
**Bug reports:** please use **[GitHub Issues](https://github.com/nandish-jha/noop-app/issues)** — there's a template, and they're tracked, deduped and linked to fixes (include a strap log).
...
This copy is a **personal fork** of the upstream project. The canonical home for NOOP remains **[github.com/NoopApp/noop](https://github.com/NoopApp/noop)** (mirrored at [noop.fans](https://noop.fans/NoopApp/noop)).

**This repo:** `git clone https://github.com/nandish-jha/noop-app.git` — see [UPSTREAM.md](UPSTREAM.md) to pull in new upstream releases.

If you mirror or fork further, keep the [`LICENSE`](LICENSE) + `Copyright 2026 NoopApp` notice intact (PolyForm Noncommercial).
...
<p>
  <img alt="Open issues" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Fopen.json&style=flat-square">
  <img alt="Issues resolved" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Fresolved.json&style=flat-square">
  <a href="https://github.com/nandish-jha/noop-app/stargazers"><img alt="Stars" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Fstars.json&style=flat-square"></a>
  <img alt="Forks" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Fforks.json&style=flat-square">
  <img alt="Commits per month" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Flastcommit.json&style=flat-square">
  <img alt="Last commit" src="https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnandish-jha%2Fnoop-app%2Fmain%2Fdocs%2Fstats%2Flastcommit.json&style=flat-square">
</p>
...
[![Star History Chart](https://api.star-history.com/svg?repos=nandish-jha/noop-app&type=Date)](https://star-history.com/#nandish-jha/noop-app&Date)
