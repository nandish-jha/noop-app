...
// Boop terracotta dark — mirrors nandish-jha/boop-app `boopTerracottaDarkPalette()`.
val DarkTokens = PaletteTokens(
    surfaceBase = Color(0xFF141413), surfaceRaised = Color(0xFF30302E), surfaceOverlay = Color(0xFF3D3D3A),
    surfaceInset = Color(0xFF252320), hairline = Color(0x1AFAF9F5), hairlineStrong = Color(0x33FAF9F5),
    textPrimary = Color(0xFFFAF9F5), textSecondary = Color(0xFFB0AEA5), textTertiary = Color(0xFF8A8480),
    glowAmbient = Color(0xFF2E2420),
    accent = Color(0xFFE88868), accentHover = Color(0xFFE8A898), accentMuted = Color(0xFF2E2420), focusRing = Color(0xFFE88868),
    recovery000 = Color(0xFFE07A6A), recovery030 = Color(0xFFE88868), recovery055 = Color(0xFFE8A898),
    recovery078 = Color(0xFFB7D18A), recovery100 = Color(0xFFB7D18A),
    strain000 = Color(0xFF5C3B26), strain033 = Color(0xFF8A5B32), strain066 = Color(0xFFD98A2B), strain100 = Color(0xFFE8A898),
    sleepAwake = Color(0xFFC77E92), sleepLight = Color(0xFF8E6FAE), sleepDeep = Color(0xFF4E3E7C), sleepREM = Color(0xFFDDA8B7),
    zone1 = Color(0xFF3C6E63), zone2 = Color(0xFF4E4278), zone3 = Color(0xFFE8A898), zone4 = Color(0xFFE88868), zone5 = Color(0xFFE07A6A),
    statusPositive = Color(0xFFB7D18A), statusWarning = Color(0xFFE8A898), statusCritical = Color(0xFFE07A6A),
    metricCyan = Color(0xFF3C6E63), metricPurple = Color(0xFF8E6FAE), metricAmber = Color(0xFFE8A898), metricRose = Color(0xFFE88868),
    chargeColor = Color(0xFFE88868), chargeDeep = Color(0xFFD46E48), chargeBright = Color(0xFFE8A898), chargeGlow = Color(0xFFE88868),
    effortColor = Color(0xFFE8A898), effortDeep = Color(0xFF8A5B32), effortBright = Color(0xFFF2C4A8), effortGlow = Color(0xFFE8A898),
    restColor = Color(0xFFC77E92), restDeep = Color(0xFF5C3B48), restBright = Color(0xFFDDA8B7), restGlow = Color(0xFFC77E92),
    stressColor = Color(0xFFE8A898), stressDeep = Color(0xFF5C3B26), stressBright = Color(0xFFE88868), stressGlow = Color(0xFFE8A898),
    scenicCenter = Color(0xFF1A1918), scenicEdge = Color(0xFF141413), scenicStar = Color(0xFFE8A898),
    cardFillTop = Color(0xFF30302E), cardFillBottom = Color(0xFF1A1918),
    gold = Color(0xFFE88868), goldLight = Color(0xFFE8A898), goldDeep = Color(0xFFD46E48),
    goldDeepText = Color(0xFF141413), signalYellow = Color(0xFFE8A898),
    titaniumTop = Color(0xFFFAF9F5), titaniumMid = Color(0xFFE8A898), titaniumLow = Color(0xFF8A8480), titaniumDeep = Color(0xFF3D3D3A),
    tipCore = Color(0xFFFAF9F5),
)
