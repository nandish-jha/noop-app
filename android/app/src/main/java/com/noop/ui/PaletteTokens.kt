...
// WHOOP-reset dark palette → warm terracotta redesign (Noop Redesign - Standalone.html).
val DarkTokens = PaletteTokens(
    surfaceBase = Color(0xFF1C1713), surfaceRaised = Color(0xFF262019), surfaceOverlay = Color(0xFF2E2721),
    surfaceInset = Color(0xFF2E2721), hairline = Color(0x14F3ECE4), hairlineStrong = Color(0x24F3ECE4),
    textPrimary = Color(0xFFF3ECE4), textSecondary = Color(0x8CF3ECE4), textTertiary = Color(0x59F3ECE4),
    glowAmbient = Color(0xFF3A2A22),
    accent = Color(0xFFF2946E), accentHover = Color(0xFFF7B497), accentMuted = Color(0xFF332229), focusRing = Color(0xFFF17A5C),
    ...
    strain000 = Color(0xFF5C3B26), strain033 = Color(0xFF8A5B32), strain066 = Color(0xFFD98A2B), strain100 = Color(0xFFE6A23C),
    sleepAwake = Color(0xFFC77E92), sleepLight = Color(0xFF8E6FAE), sleepDeep = Color(0xFF4E3E7C), sleepREM = Color(0xFFDDA8B7),
    zone1 = Color(0xFF3C6E63), zone2 = Color(0xFF4E4278), zone3 = Color(0xFFE6A23C), zone4 = Color(0xFFF17A5C), zone5 = Color(0xFFC77E92),
    statusPositive = Color(0xFFB7D18A), statusWarning = Color(0xFFE6A23C), statusCritical = Color(0xFFC77E92),
    metricCyan = Color(0xFF3C6E63), metricPurple = Color(0xFF8E6FAE), metricAmber = Color(0xFFE6A23C), metricRose = Color(0xFFC77E92),
    chargeColor = Color(0xFFF17A5C), chargeDeep = Color(0xFFD98A2B), chargeBright = Color(0xFFF7B497), chargeGlow = Color(0xFFF17A5C),
    effortColor = Color(0xFFE6A23C), effortDeep = Color(0xFF8A5B32), effortBright = Color(0xFFE6C27C), effortGlow = Color(0xFFE6A23C),
    restColor = Color(0xFFC77E92), restDeep = Color(0xFF5C3B48), restBright = Color(0xFFDDA8B7), restGlow = Color(0xFFC77E92),
    stressColor = Color(0xFFE6A23C), stressDeep = Color(0xFF5C3B26), stressBright = Color(0xFFF2946E), stressGlow = Color(0xFFE6A23C),
    scenicCenter = Color(0xFF3A2A22), scenicEdge = Color(0xFF1C1713), scenicStar = Color(0xFFF2C4A8),
    cardFillTop = Color(0xFF262019), cardFillBottom = Color(0xFF1C1713),
    gold = Color(0xFFF2946E), goldLight = Color(0xFFF7B497), goldDeep = Color(0xFFD98A2B),
    goldDeepText = Color(0xFF1C1713), signalYellow = Color(0xFFE6C27C),
    titaniumTop = Color(0xFFF3ECE4), titaniumMid = Color(0xFFF2C4A8), titaniumLow = Color(0xFF8A5B32), titaniumDeep = Color(0xFF3E2E24),
    tipCore = Color(0xFFF3ECE4),
)
