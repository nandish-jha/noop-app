...
// Boop AMOLED dark — mirrors nandish-jha/boop-app `boopDarkPalette()` (default family).
// True-black canvas, white/grey chrome. Classic chart ramps still colour *data*; UI chrome is mono.
val DarkTokens = PaletteTokens(
    surfaceBase = Color(0xFF000000), surfaceRaised = Color(0xFF1A1A1A), surfaceOverlay = Color(0xFF222222),
    surfaceInset = Color(0xFF141414), hairline = Color(0x1AFFFFFF), hairlineStrong = Color(0x33FFFFFF),
    textPrimary = Color(0xFFFFFFFF), textSecondary = Color(0xFF9E9E9E), textTertiary = Color(0xFF8A8A8A),
    glowAmbient = Color(0xFF1F1F1F),
    accent = Color(0xFFE0E0E0), accentHover = Color(0xFFFFFFFF), accentMuted = Color(0xFF1F1F1F), focusRing = Color(0xFFE0E0E0),
    recovery000 = Color(0xFFE57373), recovery030 = Color(0xFFFFB74D), recovery055 = Color(0xFFFFF176),
    recovery078 = Color(0xFFAED581), recovery100 = Color(0xFF81C784),
    strain000 = Color(0xFF757575), strain033 = Color(0xFF9E9E9E), strain066 = Color(0xFFBDBDBD), strain100 = Color(0xFFE0E0E0),
    sleepAwake = Color(0xFFBDBDBD), sleepLight = Color(0xFF9E9E9E), sleepDeep = Color(0xFF616161), sleepREM = Color(0xFFE0E0E0),
    zone1 = Color(0xFF9E9E9E), zone2 = Color(0xFFBDBDBD), zone3 = Color(0xFFE0E0E0), zone4 = Color(0xFFBDBDBD), zone5 = Color(0xFFE57373),
    statusPositive = Color(0xFF81C784), statusWarning = Color(0xFFFFB74D), statusCritical = Color(0xFFE57373),
    metricCyan = Color(0xFFBDBDBD), metricPurple = Color(0xFF9E9E9E), metricAmber = Color(0xFFE0E0E0), metricRose = Color(0xFFE57373),
    chargeColor = Color(0xFFE0E0E0), chargeDeep = Color(0xFFBDBDBD), chargeBright = Color(0xFFFFFFFF), chargeGlow = Color(0xFFE0E0E0),
    effortColor = Color(0xFFBDBDBD), effortDeep = Color(0xFF9E9E9E), effortBright = Color(0xFFE0E0E0), effortGlow = Color(0xFFBDBDBD),
    restColor = Color(0xFF9E9E9E), restDeep = Color(0xFF757575), restBright = Color(0xFFBDBDBD), restGlow = Color(0xFF9E9E9E),
    stressColor = Color(0xFFE0E0E0), stressDeep = Color(0xFF9E9E9E), stressBright = Color(0xFFE57373), stressGlow = Color(0xFFE0E0E0),
    scenicCenter = Color(0xFF000000), scenicEdge = Color(0xFF000000), scenicStar = Color(0xFFBDBDBD),
    cardFillTop = Color(0xFF1A1A1A), cardFillBottom = Color(0xFF000000),
    gold = Color(0xFFE0E0E0), goldLight = Color(0xFFFFFFFF), goldDeep = Color(0xFFBDBDBD),
    goldDeepText = Color(0xFF000000), signalYellow = Color(0xFFE0E0E0),
    titaniumTop = Color(0xFFFFFFFF), titaniumMid = Color(0xFFE0E0E0), titaniumLow = Color(0xFF9E9E9E), titaniumDeep = Color(0xFF616161),
