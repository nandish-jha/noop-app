...
Reads counts from the GitHub API (https://api.github.com/repos/nandish-jha/noop-app) using the token
...
API="https://api.github.com/repos/nandish-jha/noop-app"
...
open_issues=search_count("repo:nandish-jha/noop-app is:issue is:open")
resolved=search_count("repo:nandish-jha/noop-app is:issue is:closed")
